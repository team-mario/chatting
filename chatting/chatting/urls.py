...
urlpatterns = [
    ...
    url(r'^accounts/change_password/$', 'django.contrib.auth.views.password_change',
        {'post_change_redirect': 'message.views.get_message_list'}),
    url(r'^password_change/done/$',
        'django.contrib.auth.views.password_change_done'),
    url(r'^issue/create$', 'team.views.create_issue', name='create_issue'),
    url(r'^issue/$', 'message.views.get_message_list'),
    url(r'^issue/(?P<issue_name>[\w-]+)', 'message.views.get_message_list', name='issue_detail'),
